...
export async function GET(
  ...
  try {
    ...
    const filename = standaloneZipFilename(course.title);
    await recordExportEvent(supabase, user, courseId, "standalone");
    ...
    reportScormExportFailure(err, { courseId, format: "standalone" });
    console.error("[standalone-export]", courseId, err);
