...
export async function GET(
  ...
  try {
    ...
    const filename = scorm2004ZipFilename(course.title);
    await recordExportEvent(supabase, user, courseId, "scorm2004");
    ...
    reportScormExportFailure(err, { courseId, format: "scorm2004" });
    console.error("[scorm-2004-export]", courseId, err);
